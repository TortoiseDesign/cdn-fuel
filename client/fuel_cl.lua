		...
		if Config.PlayerOwnedGasStationsEnabled and not Config.UnlimitedFuel and not RefuelingType == 'special' then
			if ReserveLevels < maxfuel then
				...
				fuel = exports['qb-input']:ShowInput({
					header = "Chọn lượng nhiên liệu<br>Giá hiện tại: $" ..
					FuelPrice .. " / Lít <br> Nhiên liệu hiện tại: " .. finalfuel .. " Lít <br> Chi phí đầy bình: $" ..
					...
					inputs = { {
						...
						isRequired = true,
						name = 'số lượng',
						text = 'Chỉ một '..ReserveLevels..' lít có sẵn.'
					}}
				})
			else
				fuel = exports['qb-input']:ShowInput({
